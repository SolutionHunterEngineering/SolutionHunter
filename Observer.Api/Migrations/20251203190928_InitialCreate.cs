        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServerUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProblemCases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HunterServerId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    CreatedUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProblemCases_ServerUserId",
                table: "ProblemCases",
                column: "ServerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ServerUsers_EngineerUserId_HunterServerId",
                table: "ServerUsers",
                columns: new[] { "EngineerUserId", "HunterServerId" },
                unique: true);

...
namespace Hunter.Api.Database.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KnownAs = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    Organization = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    AltPhone = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUserRoles", x => new { x.ServerId, x.UserId, x.RoleId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_Users_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_ServerId_NormalizedName",
                table: "AspNetRoles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_ServerId_NormalizedUserName",
                table: "Users",
                columns: new[] { "ServerId", "NormalizedUserName" },
                unique: true,
